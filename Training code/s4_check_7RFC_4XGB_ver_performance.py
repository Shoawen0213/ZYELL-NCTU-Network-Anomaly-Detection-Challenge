...
def main(dataframe):
    ...
    del model11_pred_prob_dfdel model1_pred_prob_df, model2_pred_prob_df, model3_pred_prob_df, model4_pred_prob_df, model5_pred_prob_df
    del model6_pred_prob_df, model7_pred_prob_df, model8_pred_prob_df, model9_pred_prob_df, model10_pred_prob_df
...
m=0
test_model1 = joblib.load('./0306_final_stage_dt_clfver_7RFC_ver2.pkl')
m+=1
test_model2 = joblib.load('./0306_final_stage_mlp_clfver_7RFC_ver2.pkl')
m+=1
test_model3 = joblib.load('./0306_final_stage_rf_clfver_7RFC_ver2.pkl')
m+=1
