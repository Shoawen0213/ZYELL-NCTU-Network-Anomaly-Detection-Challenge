...
m+=1
model2 = joblib.load('./model_0228_fitWHOLE_1.pkl')
m+=1
model3 = joblib.load('./model_0228_fitWHOLE_2.pkl')
m+=1
model4 = joblib.load('./model_0228_fitWHOLE_3.pkl')
m+=1
model5 = joblib.load('./model_0228_fitWHOLE_4.pkl')
m+=1
...
def main(dataframe):
    ...
    print('//-------------------------//')
    concat_all_label = pd.concat([model1_, model2_, model3_, model4_, model5_], axis=1)
...
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_05_0123_firewall.csv', index=False, encoding='utf-8-sig')
...
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_05_0124_firewall.csv', index=False, encoding='utf-8-sig')
...
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_05_0125_firewall.csv', index=False, encoding='utf-8-sig')
...
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_05_0126_firewall.csv', index=False, encoding='utf-8-sig')
