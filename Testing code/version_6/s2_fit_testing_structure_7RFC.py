...
m+=1
model2 = joblib.load('./rfc_0306_slice_all_ver1.pkl')
m+=1
model3 = joblib.load('./rfc_0306_slice_all_ver2.pkl')
m+=1
model4 = joblib.load('./rfc_0306_slice_all_ver3.pkl')
m+=1
model5 = joblib.load('./rfc_0306_slice_all_ver4.pkl')
m+=1
model6 = joblib.load('./rfc_0306_slice_all_ver5.pkl')
m+=1
model7 = joblib.load('./rfc_0306_slice_all_ver6.pkl')
m+=1
...
model_s2 = joblib.load('./0306_final_stage_rf_clfver_7RFC_ver2.pkl')
...
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_06_0123_firewall.csv', index=False, encoding='utf-8-sig')
...
print("//    Now Store the result    //")
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_06_0124_firewall.csv', index=False, encoding='utf-8-sig')
...
print("//    Now Store the result    //")
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_06_0125_firewall.csv', index=False, encoding='utf-8-sig')
...
print("//    Now Store the result    //")
#store to csv files 
concat_data.to_csv('./131_OASIS LAB_06_0126_firewall.csv', index=False, encoding='utf-8-sig')
